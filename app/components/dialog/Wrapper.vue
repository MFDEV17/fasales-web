...
<template>
  <DialogRoot @update:open="dialog.resetDialog()" v-model:open="dialogOpen">
    <DialogPortal>
      ...
      <DialogContent
        class="text-telegram-link data-[state=open]:animate-contentShow data-[state=closed]:animate-contentHide bg-telegram-bg-secondary fixed left-[50%] top-[50%] z-[100] h-full max-h-[75dvh] w-[90vw] max-w-screen-md translate-x-[-50%] translate-y-[-50%] overflow-y-scroll rounded-2xl outline-none"
      >
        <DialogTitle
